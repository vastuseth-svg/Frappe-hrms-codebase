...
- Name: vs02_a_tenant_creation.spec.ts >> VS-02-A: Tenant Creation (Super Admin) >> Blank tenant_code is caught by client validation before submission
- Location: tests/e2e/vs02_a_tenant_creation.spec.ts:149:3
  ...
  - generic [ref=e12]:
    ...
    - generic [ref=e17]:
      ...
      - textbox "Password" [ref=e20]:
        - /placeholder: ••••••••
        - text: admin
    - button "Continue with OTP" [ref=e22] [cursor=pointer]
```
